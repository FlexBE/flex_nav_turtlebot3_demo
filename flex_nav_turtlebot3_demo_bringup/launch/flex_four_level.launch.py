...
def generate_launch_description():
    ...
    low_mid_level_params = RewrittenYaml(source_file=os.path.join(bringup_dir, 'param',
                                                                  'low_mid_level_planner_params.yaml'),
                                         root_key="",
                                         param_rewrites=param_substitutions,
                                         convert_types=True)

    low_middle_costmap_params = RewrittenYaml(source_file=os.path.join(bringup_dir, 'param',
                                                                       'low_middle_costmap_params.yaml'),
                                              root_key="",
                                              param_rewrites=param_substitutions,
                                              convert_types=True)
    ...
    behavior_params = RewrittenYaml(source_file=os.path.join(bringup_dir, 'param',
